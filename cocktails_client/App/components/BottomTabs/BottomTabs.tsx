                ...
                {state.routes.map((route, index) => {
                    ...
                    const onPress = () => {
                        ...
                        if (!isFocused && !event.defaultPrevented) {
                            navigation.navigate(route.name, state.routes.find(e => e.name === 'Cocktails')?.params);
                        }
                    };
                    ...
                    return (
                        ...
                        >
                            {label === 'Cocktails' ? <DrinksIcon /> : label === 'MyCocktails' ? <CocktailIcon /> : label === 'Account' ? <UserIcon /> : null}
                        </TouchableOpacity>
                    );
                })}
            </View>
